      ...
      <div className="pa3-l">
        <form onSubmit={(e) => this.onFormSubmit(e)} className="center w-100 w-75-ns br2-ns">
          <fieldset className="cf w-100 bn ma0 pa0">
            <legend className="pa0 tc f5 f4-ns mb3 black-80">Search for Developers in any Organization</legend>
            <div className="cf">
              <input onChange={(e) => this.onInputChange(e)} value={this.state.term}
                ...
                placeholder={this.props.organization.current ? `Showing ${this.props.organization.current} developers` : 'Mozilla Foundation'} type="text"
                name="Org_Search" />
