...
class CheckoutList extends Component {
  ...
  constructor(props) {
    super(props)
    this.state = {developersInCart: this.props.developers}
  }
  ...
  componentWillMount() {
    ...
    let developersInCart = Object.assign({}, this.state.developersInCart);
  ...
  render() {
    let renderedDevs = Object.assign({}, this.state.developersInCart);
